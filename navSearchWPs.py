...
f.write(F"{len(lat)+20} 0	3	20	0.00000000	0.00000000	0.00000000	0.00000000	0.00000000	0.00000000	0.000000	1\n")
#Loiter for a set time, currently 60 seconds
f.write(F"{len(lat)+21} 0	3	19	60.00000000	0.00000000	0.00000000	0.00000000	0.00000000	0.00000000	0.000000	1")
f.close()